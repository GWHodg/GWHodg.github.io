...
/* +++++++++++++++++++++++ ADDED BY DOUG ^ ++++++++++++++++++++++++++++++++++++++ */	
	...
	function BLURfn(SCRinput) {
		...
		document.getElementById("TD"+SCRinput).style.background = "white";//"black";
		document.getElementById("focusIPT").style.background = "white";
			document.getElementById("focusIPT").style.color = "maroon";
			document.getElementById("focusIPT").value = "witGS";//"GSmac3x"; 		//GLOBALinput;
				...
				for (var p = 2; p < 6; p++) {
						if ( document.getElementById("p"+p+"NAME").value == "" ) {
							...
							for (var h = 1; h < 19; h++) {
								...
								document.getElementById('TDp'+p+'h'+h).style.background = "slategray";
								document.getElementById('SPp'+p+'h'+h).style.background = "slategray";
							}	
			...
			for (var p = 2; p < 6; p++) {
				if ( document.getElementById("p"+p+"NAME").value == "" ) {
					for (var h = 1; h < 19; h++) {
						...
						document.getElementById('TDp'+p+'h'+h).style.background = "beige";
						document.getElementById('SPp'+p+'h'+h).style.background = "beige";
					}	
